                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-heading fw-bold">Catshop</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form id="formAuthentication" class="mb-6" method="POST">
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control" id="username" name="username_230012"
                                    placeholder="Enter your username" autofocus />
                            </div>
                            <div class="mb-6 form-password-toggle">
                                <label class="form-label" for="password">Password</label>
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control" name="password_230012"
                                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                            ...
                            <div class="mb-6">
                                <button class="btn btn-primary d-grid w-100" type="submit" value="Login" name="login">Login</button>
                            </div>
                        </form>
