            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a
                    ...
                    <div class="avatar avatar-online">
                        <img src="<?= base_url('uploads/users/' . $this->session->userdata('photo_230012')) ?>" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                </a>
                        ...
                        <div class="dropdown-item">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <small class="text-body-secondary"><?= $this->session->userdata('usertype_230012') ?></small>
                                </div>
                            </div>
                        </div>
                    </li>
